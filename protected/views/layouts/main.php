          ...
          <?php
            ...
            $this->widget('zii.widgets.CMenu',array(
                'items'=>array(
                    ...
                    //Enlaces de batalla
                  array('label'=>'Iniciar batalla', 'url'=>array('/event/start'), 'visible'=>(Yii::app()->user->checkAccess('Usuario') && Yii::app()->user->checkAccess('lanzar_evento') && isset(Yii::app()->event->model) && Yii::app()->event->status==Yii::app()->params->statusIniciado && Yii::app()->event->hasEnrollments()), 'itemOptions' => array('id' => 'btnBattle')),
