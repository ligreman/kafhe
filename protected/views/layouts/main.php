...
<html>
    <head>
        ...
        <?php
            ...
            Yii::app()->clientScript->registerScriptFile(Yii::app()->request->baseUrl.'/js/owl.carousel.min.js');
    ...
    <div id="page">
        ...
        <nav id="secondary_nav">
          <?php
            ...
            $this->widget('zii.widgets.CMenu',array(
                'items'=>array(
                    //Menú principal
                    array('label'=>'Notificaciones', 'url'=>Yii::app()->homeUrl, 'visible'=>(Yii::app()->user->checkAccess('Usuario')), 'active'=>($this->id=='site' && !isset($this->action->view))?true:false),
                    array('label'=>'Corral', 'url'=>array('/corral'), 'visible'=>(Yii::app()->user->checkAccess('Usuario') && isset(Yii::app()->event->model) && Yii::app()->event->type=='desayuno' && (Yii::app()->event->status==Yii::app()->params->statusIniciado || Yii::app()->event->status==Yii::app()->params->statusCalma || Yii::app()->event->status==Yii::app()->params->statusBatalla)), 'active'=>$this->id=='corral'?true:false),
                    array('label' => ''),
          ...
          ?>
            ...
            <footer>
                <ul id="tools">
                    ...
                    <?php if (!Yii::app()->user->isGuest): ?>
                        <li><a target="_blank" href="http://kafhe.hol.es/wiki/index.php?title=Changelog">Log de cambios</a></li>
                    ...
                    <li><a target="_blank" href="http://kafhe.hol.es/wiki/index.php?title=Normas_de_comportamiento">Normas de comportamiento</a></li>
        ...
        <?php
            //Aquí controlo si la página va a tener panel lateral derecho o no, con el ancho del main
            if ( ($this->id=='site' && !isset($this->action->view)) || $this->id=='corral') {
                $class = '';
            } else $class = 'full';
        ?>

        <section id="main" class="<?php echo $class; ?>">
            <?php
