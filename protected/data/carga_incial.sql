...
CREATE TABLE IF NOT EXISTS `event` (
  ...
  `last_gungubos_repopulation` date NULL DEFAULT NULL,
  `last_gungubos_criadores` datetime NULL DEFAULT NULL,
...
INSERT INTO `configuration` (`param`, `value`, `category`, `description`) VALUES('tuesteRegeneradoIntervalo', '10', 'Juego', 'Puntos de tueste regenerado en cada intervalo de regeneración.');
