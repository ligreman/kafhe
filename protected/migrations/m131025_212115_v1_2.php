...
class m131025_212115_v1_2 extends CDbMigration
{
    ...
    public function safeUp()
    {
        ...
        $this->update('skill', array('require_event_status'=>'1,2'), 'keyword=:key', array(':key'=>'trampa'));
    ...
    public function safeDown()
    {
        ...
        $this->update('skill', array('require_event_status'=>NULL), 'keyword=:key', array(':key'=>'trampa'));
