...
class m131129_182205_kafhe_3_4 extends TXDbMigration
{
	public function safeUp()
	{
        ...
        $this->execute('ALTER TABLE skill ADD generates_notification tinyint(1) NULL DEFAULT 1 AFTER require_talent_id;');
        ...
        $this->insert('skill', array(
            'name'  =>  'Hidratar',
            'description'  =>  'Aumenta tu ritmo de regeneración de tueste durante 24 horas. No se acumula.',
