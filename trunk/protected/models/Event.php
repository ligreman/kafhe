...
class Event extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('group_id, caller_id, relauncher_id, status, gungubos_population, gungubos_kafhe, fame_kafhe, gungubos_achikhoria, fame_achikhoria, stored_tueste_kafhe, stored_tueste_achikhoria', 'numerical', 'integerOnly'=>true),
			array('caller_side', 'length', 'max'=>10),
			array('type', 'length', 'max'=>8),
			array('last_gungubos_criadores', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, group_id, caller_id, caller_side, relauncher_id, status, gungubos_population, gungubos_kafhe, fame_kafhe, gungubos_achikhoria, fame_achikhoria, last_gungubos_criadores, stored_tueste_kafhe, stored_tueste_achikhoria, type, date', 'safe', 'on'=>'search'),
		);
	}
